...
let result = transporter.sendMail({
  ...
  let formSub = document.querySelector('form_subscription')
  
  formSub.onsubmit = function (evt) {
    evt.preventDefault();
    let  activeForm = document.createElement('.price__benefits_item');
    formSub.append(activeForm)
  }
